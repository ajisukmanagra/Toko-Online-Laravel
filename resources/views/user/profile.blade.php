...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Halaman &mdash; Profil</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="media-body">
                            <div class="personal_text">
                                ...
                                <ul class="list basic_info">
                                    ...
                                    <li><a href="#"><i
                                                class="lnr lnr-calendar-full"></i>{{ date('l, d F Y', strtotime($user->tanggal_lahir)) }}</a>
                                    </li>
                                    @else
                                    <li><a href="#"><i class="lnr lnr-calendar-full"></i>Saturday, 26 October 2021</a>
                                    </li>
                                    @endif
                                    @if($user->telepon)
                                    <li><a href="#"><i class="lnr lnr-phone-handset"></i>{{ $user->telepon }}</a></li>
                                    @else
                                    <li><a href="#"><i class="lnr lnr-phone-handset"></i>089657840051</a></li>
                                    @endif
                                    @if($user->email)
                                    <li><a href="#"><i class="lnr lnr-envelope"></i>{{ $user->email }}</a></li>
                                    @else
                                    <li><a href="#"><i class="lnr lnr-envelope"></i>sukmanagaraa@gmai.com</a></li>
                                    @endif
                                    @if($user->address && $user->kelurahan && $user->kecamatan && $user->kabupaten &&
                                    $user->provinsi)
                                    <li><a href="#"><i class="lnr lnr-home"></i>{{ $user->address }},
                                            {{ $user->kelurahan }}, {{ $user->kecamatan }}, {{ $user->kabupaten }},
                                            {{ $user->provinsi }}</a></li>
                                    @else
                                    <li><a href="#"><i class="lnr lnr-home"></i>Cianjur, Jawa Barat</a></li>
                                    @endif
                                </ul>
                            </div><br><br>
